...
O presente projeto foi um projeto académico, onde tive o meu primeiro contacto com API e tokens de acesso, e teve como objetivo criar uma aplicação mobile para gestão do processo de condidatura a estagios,bem como o processo de seleção de candidatos aos estagios. 
